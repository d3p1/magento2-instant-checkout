...
A [Magento 2](https://business.adobe.com/products/magento/magento-commerce.html) development that makes the implementation of an instant checkout flow easier.
...
```
composer require d3p1/module-instant-checkout
